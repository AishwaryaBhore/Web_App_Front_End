...
def main():
    global lowercase_tal, lowercase_supression, lowercase_email, lowercase_jt_link
    try:
        ...
        company_name = load_conditions_from_excel(file_path, column_number=12)
        ...
        for i in range(1, 22):
            ...
            try:
                ...
                try:
                    if company_name:
                        all_results_df = all_results_df[all_results_df['Company_Name'].isin(company_name)]
